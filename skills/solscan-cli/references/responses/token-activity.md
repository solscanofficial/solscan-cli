# Token Response Fields — Activity
...
This covers **time-ordered activity** for a token — transfers and DeFi actions — as opposed to DEX pool/market listings ([token-market.md](token-market.md)).
